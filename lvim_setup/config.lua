...
lvim.keys.normal_mode["vs"] = ":vsp<cr>"                      -- Split a new window
lvim.keys.normal_mode["hs"] = ":sp<cr>"                       -- Split a new window
lvim.keys.normal_mode["sc"] = "<C-w>c"                        -- Close current window

-- Visual mode keymappings
lvim.keys.visual_mode["<"] = "<gv"                            -- 缩进代码
lvim.keys.visual_mode[">"] = ">gv"                            -- 缩进代码
